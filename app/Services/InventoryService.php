...
class InventoryService
{
     ...
     */
    public function addStockFromPurchase(Material $material, int $qty, float $newPrice, $reference = null)
    {
     ...
     */
    public function reduceStockForProduction(Material $material, int $qty, $reference = null)
    {
