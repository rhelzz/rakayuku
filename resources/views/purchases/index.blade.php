...
<div class="space-y-6">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h2 class="font-headline-md text-headline-md text-on-surface mb-1">Purchases & Receipts</h2>
            <p class="font-body-sm text-body-sm text-slate-400">Track raw material inward receipts and costs.</p>
        </div>
    ...
    <div class="bg-surface-container-low border border-surface-variant rounded-xl flex flex-col overflow-hidden shadow-sm">
        <div class="p-4 border-b border-surface-variant flex justify-between items-center bg-surface-container-lowest/50">
            <h3 class="font-title-sm text-title-sm text-on-surface">Purchase Records</h3>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                <thead class="bg-surface-container sticky top-0 z-10">
                    <tr>
                        <th class="px-4 py-3 font-label-caps text-label-caps text-slate-400 uppercase border-b border-surface-variant">Date</th>
                        <th class="px-4 py-3 font-label-caps text-label-caps text-slate-400 uppercase border-b border-surface-variant">Invoice #</th>
                        <th class="px-4 py-3 font-label-caps text-label-caps text-slate-400 uppercase border-b border-surface-variant">Supplier</th>
                        <th class="px-4 py-3 font-label-caps text-label-caps text-slate-400 uppercase border-b border-surface-variant text-right">Total Price</th>
                        <th class="px-4 py-3 font-label-caps text-label-caps text-slate-400 uppercase border-b border-surface-variant text-center">Items</th>
                ...
                <tbody class="divide-y divide-surface-variant font-body-sm text-body-sm text-on-surface">
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="px-4 py-8 text-center text-slate-500 italic">No purchase records found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
