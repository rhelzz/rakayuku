        ...
        <div class="flex flex-col gap-5">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div class="flex-shrink-0">
                    <a href="{{ route('orders.create') }}" class="inline-flex px-5 py-2.5 bg-primary text-white rounded-xl font-bold hover:bg-primary-hover shadow-lg shadow-primary/20 transition-all items-center gap-2 text-sm">
                        <span class="material-symbols-outlined text-[20px]">add</span> Pesanan Baru
                    </a>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2 overflow-x-auto pb-2 -mx-4 px-4 md:mx-0 md:px-0" style="scrollbar-width: none;">
                ...
                <button @click="exportUrl = '{{ route('materials.export') }}'; exportTitle = 'Bahan'; showExportModal = true" class="flex-shrink-0 px-3 py-1.5 text-xs font-semibold bg-purple-50 text-purple-700 rounded-lg hover:bg-purple-100 transition-colors border border-purple-200">Bahan</button>
                <button @click="exportUrl = '{{ route('purchases.export') }}'; exportTitle = 'Pembelian'; showExportModal = true" class="flex-shrink-0 px-3 py-1.5 text-xs font-semibold bg-amber-50 text-amber-700 rounded-lg hover:bg-amber-100 transition-colors border border-amber-200">Pembelian</button>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
            ...
            <div class="glass-panel rounded-xl p-4 flex flex-col gap-2 relative overflow-hidden group">
                ...
                <div class="flex flex-col mt-2">
                    <span class="text-xl xl:text-2xl font-bold tracking-tight text-on-background leading-none truncate">{{ $activeOrders }}</span>
            ...
            <div class="glass-panel rounded-xl p-4 flex flex-col gap-2 relative overflow-hidden group {{ count($lowStockMaterials) > 0 ? 'border-l-4 border-l-error' : '' }}">
                ...
                <div class="flex flex-col mt-2">
                    <span class="text-xl xl:text-2xl font-bold tracking-tight text-on-background leading-none truncate">{{ count($lowStockMaterials) }}</span>
            ...
            <div class="glass-panel rounded-xl p-4 flex flex-col gap-2 relative overflow-hidden group">
                ...
                <div class="flex flex-col mt-2 overflow-hidden">
                    <span class="text-xl xl:text-2xl font-bold tracking-tight text-on-background truncate" title="{{ formatRupiah($totalProfit) }}">{{ formatRupiah($totalProfit) }}</span>
            ...
            <div class="glass-panel rounded-xl p-4 flex flex-col gap-2 relative overflow-hidden group border-l-4 border-l-amber-500">
                ...
                <div class="flex flex-col mt-2 overflow-hidden">
                    <span class="text-xl xl:text-2xl font-bold tracking-tight text-on-background truncate" title="{{ formatRupiah($totalReceivable) }}">{{ formatRupiah($totalReceivable) }}</span>
