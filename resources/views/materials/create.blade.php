...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-surface-container-low border border-surface-variant rounded-xl overflow-hidden shadow-xl">
        <div class="p-6 border-b border-surface-variant bg-surface-container-lowest/50 relative overflow-hidden">
            ...
            <p class="font-body-sm text-body-sm text-slate-400 relative z-10">Register a new raw material item to the inventory system.</p>
        </div>
        ...
        <form action="{{ route('materials.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="space-y-4">
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="name" id="name" required class="w-full bg-surface-container-highest border border-slate-700 text-on-surface rounded-lg px-3 py-2 focus:border-primary-container focus:ring-1 focus:ring-primary-container transition-colors" placeholder="e.g. Teak Wood A-Grade">
                </div>
