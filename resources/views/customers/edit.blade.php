        ...
        <form action="{{ route('customers.update', $customer) }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="space-y-4">
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $customer->name) }}" required class="w-full bg-white border border-slate-200 text-on-surface rounded-lg px-3 py-2 focus:border-primary-container focus:ring-1 focus:ring-primary-container transition-colors @error('name') border-error @enderror" placeholder="Misal: John Doe">
                    @error('name')
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email', $customer->email) }}" class="w-full bg-white border border-slate-200 text-on-surface rounded-lg px-3 py-2 focus:border-primary-container focus:ring-1 focus:ring-primary-container transition-colors @error('email') border-error @enderror" placeholder="Misal: john@example.com">
                    @error('email')
                        <p class="text-[11px] text-error mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="phone" id="phone" value="{{ old('phone', $customer->phone) }}" required class="w-full bg-white border border-slate-200 text-on-surface rounded-lg px-3 py-2 focus:border-primary-container focus:ring-1 focus:ring-primary-container transition-colors @error('phone') border-error @enderror" placeholder="Misal: 08123456789">
                    @error('phone')
                        <p class="text-[11px] text-error mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea name="address" id="address" rows="3" required class="w-full bg-white border border-slate-200 text-on-surface rounded-lg px-3 py-2 focus:border-primary-container focus:ring-1 focus:ring-primary-container transition-colors @error('address') border-error @enderror" placeholder="Alamat lengkap...">{{ old('address', $customer->address) }}</textarea>
                    @error('address')
                        <p class="text-[11px] text-error mt-1">{{ $message }}</p>
                    @enderror
                </div>
