...
<div class="glass-panel border border-surface-variant rounded-xl p-4 mb-6" x-data="{ showCustomDate: '{{ request('date_range') === 'custom' }}' }">
    <form action="{{ url()->current() }}" method="GET" class="flex flex-wrap gap-4 items-end">
        ...
        <div class="w-48 space-y-1.5">
            ...
            <select name="date_range" @change="showCustomDate = ($el.value === 'custom')" 
